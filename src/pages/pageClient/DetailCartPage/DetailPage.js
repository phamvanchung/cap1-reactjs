...
import Search from '../../../components/componentsClient/Content/Search/Search'
import './Detail.scss';
            ...
            <div>
                ...
                <div className="grid__row">
                    ...
                    <div className="information_shop">
                        ...
                        <p className="infor_shopName">ĐÔNG Á MOTOR</p>
                        </div>
                        <div className="form_dn">
                        <button className="btn btn-info">Đặt Ngay</button>
                        </div>
                    </div>
                    <div className="infor_image-wrapper">
                        <img className="infor_image_1" src="https://quangcaonhat.com/wp-content/uploads/2020/05/bang-hieu-tiem-sua-xe-4.png" alt="" />
                    </div>
                    <div className="infor_context">
                        <p className="top_pick_heading">Mô tả về cửa hàng</p>
                        <p className="context">
                        Đông á motor chuyên cung cấp các dịch vụ sửa chữa các loại xe máy thông dụng và bên cạch đó là các loại motor phân khối lớn.
                        </p>
                        ...
                        <div className="user_comment">
                            ...
                            <li className="user_comment_item">
                                ...
                                <div className="user_avatar">
                                    <img src="./assets/image/pexels-katie-e-3671083.jpg" alt="" className="avatar_img" />
                                </div>
                            ...
                            <li className="user_comment_item">
                                <div className="user_infor">
                                <div className="user_avatar">
                                    <img src="./assets/image/pexels-mikhail-nilov-6706763.jpg" alt="" className="avatar_img" />
                                </div>
                            ...
                            <li className="user_comment_item">
                                <div className="user_infor">
                                <div className="user_avatar">
                                    <img src="./assets/image/pexels-petra-bauman-1565538.jpg" alt="" className="avatar_img" />
                                </div>
